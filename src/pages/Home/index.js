...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let response = await fetch(`https://scholarshipandcourse.rizqisyahrendra.tech/v1/scholarships?category=1`);
      response = await response.json();
      setDataScholarship(response.data.slice(0,3));

      response = await fetch(`https://scholarshipandcourse.rizqisyahrendra.tech/v1/scholarships?category=2`);
      response = await response.json();
